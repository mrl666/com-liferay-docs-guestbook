 ...
 * <code>com.liferay.docs.guestbook.service.EntryService</code> interface.
 *
 * <p>
...
public class EntryServiceImpl extends EntryServiceBaseImpl {
	 ...
	 * <code>com.liferay.docs.guestbook.service.EntryServiceUtil</code> to access
	 * the entry remote service.
	 */
	...
	public Entry deleteEntry(long entryId, ServiceContext serviceContext) throws PortalException {
		...
		entry = EntryLocalServiceUtil.deleteEntry(entryId);
