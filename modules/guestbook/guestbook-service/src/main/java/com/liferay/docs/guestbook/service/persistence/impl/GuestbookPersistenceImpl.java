...
public class GuestbookPersistenceImpl
	 ...
	 */
	@Override
	public List<Guestbook> findByG_N(
	 ...
	 */
	@Override
	public Guestbook findByG_N_First(
			long groupId, String name,
			OrderByComparator<Guestbook> orderByComparator)
		throws NoSuchGuestbookException {

		Guestbook guestbook = fetchByG_N_First(
	 ...
	 */
	@Override
	public Guestbook fetchByG_N_First(
		long groupId, String name,
		OrderByComparator<Guestbook> orderByComparator) {

		List<Guestbook> list = findByG_N(
	 ...
	 */
	@Override
	public Guestbook findByG_N_Last(
			long groupId, String name,
			OrderByComparator<Guestbook> orderByComparator)
		throws NoSuchGuestbookException {
	 ...
	 */
	@Override
	public Guestbook fetchByG_N_Last(
		long groupId, String name,
		OrderByComparator<Guestbook> orderByComparator) {
	 ...
	 */
	@Override
	public Guestbook[] findByG_N_PrevAndNext(
			long guestbookId, long groupId, String name,
			OrderByComparator<Guestbook> orderByComparator)
		throws NoSuchGuestbookException {
		...
		try {
			...
			array[0] = getByG_N_PrevAndNext(
				session, guestbook, groupId, name, orderByComparator, true);

			array[1] = guestbook;

			array[2] = getByG_N_PrevAndNext(
				session, guestbook, groupId, name, orderByComparator, false);
	...
	protected Guestbook getByG_N_PrevAndNext(
		Session session, Guestbook guestbook, long groupId, String name,
		OrderByComparator<Guestbook> orderByComparator, boolean previous) {
	...
	private static final String _FINDER_COLUMN_G_N_NAME_3 =
		"(guestbook.name IS NULL OR guestbook.name = '')";
	...
	public Guestbook updateImpl(Guestbook guestbook) {
		...
		if (!GuestbookModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			args = new Object[] {
				guestbookModelImpl.getGroupId(), guestbookModelImpl.getName()
			};
